...
import {
  ...
  planSteps,
} from '../../core/combined-actions';
import { ImpactMetricsComponent, PredictionStatus } from './impact-metrics.component';
import { TrainSequenceComponent } from './train-sequence.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TrainSequenceComponent, ImpactMetricsComponent],
