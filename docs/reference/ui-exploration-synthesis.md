...
> `docs/archive/ui-exploration-prompt.md` (the prompt that generated these).
...
prompt in `docs/archive/ui-exploration-prompt.md` (and below) can turn any single widget
