...
- [scenario-infrastructure-gallery.md](plans/scenario-infrastructure-gallery.md) — the entity model: Netz · Programm · Szenario · Layout · Modus · Aufbau · Tour, what each must describe, a `/scenarios` gallery over them, and the start screen as its front door
